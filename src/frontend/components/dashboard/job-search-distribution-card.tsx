...
export function JobSearchDistributionCard({
  ...
  return (
    <section
      className="min-w-0 scroll-mt-28 rounded-3xl border border-blue-950/8 bg-white/92 p-5 shadow-[0_24px_75px_-52px_rgb(15_23_42_/_0.42)] backdrop-blur-xl sm:p-7 lg:p-8"
      id={id}
    >
