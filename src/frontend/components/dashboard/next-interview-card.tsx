...
export function NextInterviewCard({
  ...
  const className = cn(
    "group/reminder grid min-w-0 grid-cols-[2.5rem_minmax(0,1fr)_auto] gap-3 rounded-2xl border border-blue-950/8 bg-white/92 px-4 py-4 shadow-[0_18px_55px_-45px_rgb(15_23_42_/_0.35)] backdrop-blur-xl sm:grid-cols-[2.5rem_11rem_minmax(0,1fr)_auto] sm:items-center sm:gap-4 sm:px-5",
    href &&
