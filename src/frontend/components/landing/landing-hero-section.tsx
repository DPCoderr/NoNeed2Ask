...
export function LandingHeroSection() {
  return (
    <section className="relative isolate overflow-hidden border-b border-slate-200/80 bg-[#f7f8fa] px-5 pb-14 pt-32 sm:px-8 sm:pb-20 sm:pt-36 lg:pb-24 lg:pt-40">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:gap-14">
        <div className="mx-auto min-w-0 max-w-xl text-center lg:mx-0 lg:text-left">
          ...
          <p className="mx-auto mt-6 max-w-lg text-pretty text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 lg:mx-0">
        ...
        <div className="relative isolate mx-auto w-full max-w-[29rem] min-w-0">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-[12%] -left-[10%] -right-[16%] -top-[10%] -z-10 -rotate-6 bg-[url('/landing/hero-blue-blob.svg')] bg-[length:100%_100%] bg-center bg-no-repeat blur-[4px] sm:-right-[20%]"
          />
          ...
          <div className="mx-auto mt-4 flex w-fit max-w-full items-center gap-3 rounded-2xl rounded-br-sm border border-slate-200 bg-white px-4 py-3 lg:ml-auto lg:mr-0">
