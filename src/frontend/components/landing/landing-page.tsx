...
function PhoneFrame({
  ...
  return (
    <figure
      className={cn(
        "relative overflow-hidden rounded-[2.15rem] border-[6px] border-slate-950 bg-slate-950 p-1.5 shadow-[0_35px_80px_-35px_rgb(15_23_42_/_0.75)] ring-1 ring-white/25",
        className,
      )}
    >
      <span
        aria-hidden="true"
        className="absolute left-1/2 top-2.5 z-10 h-4 w-20 -translate-x-1/2 rounded-full bg-slate-950"
      />
  ...
  return (
    <main className="min-h-svh overflow-hidden bg-[#f8fbff] text-slate-950">
      <section className="relative isolate overflow-hidden border-b border-blue-100/80 bg-[linear-gradient(145deg,#f8fbff_10%,#edf7ff_52%,#f6faff_100%)]">
        ...
        <div className="mx-auto grid min-w-0 w-full max-w-7xl gap-12 px-5 pb-16 pt-32 sm:px-6 sm:pb-20 sm:pt-36 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-8 lg:pb-24 lg:pt-32 xl:pt-40">
          <div className="relative z-10 min-w-0 max-w-2xl">
            <LandingReveal>
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200/80 bg-white/75 px-3 py-1.5 text-xs font-semibold text-blue-900 shadow-sm backdrop-blur sm:text-sm">
            ...
            <LandingReveal delay={80}>
              <h1 className="mt-6 max-w-3xl text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.05em] text-slate-950 sm:text-6xl sm:leading-[0.98] lg:text-6xl xl:text-[4.25rem]">
                Track applications privately. <span className="text-primary">Share progress simply.</span>
              </h1>
            </LandingReveal>
          ...
          <LandingReveal
            className="relative mx-auto min-w-0 w-full max-w-2xl lg:mx-0"
            delay={180}
            motion="fade"
          >
            <div
              aria-hidden="true"
              className="absolute inset-x-10 bottom-0 h-24 rounded-full bg-blue-400/20 blur-3xl"
            />
            <BrowserFrame
              alt="Private NoNeed2Ask dashboard with application totals and the next planned interview"
              className="relative z-10"
              height={900}
              imageClassName="max-sm:h-[270px] max-sm:w-auto max-sm:max-w-none max-sm:object-cover max-sm:object-left-top"
              preload
              sizes="(max-width: 639px) 640px, (max-width: 1023px) 90vw, 56vw"
              src="/landing/hero-dashboard.webp"
              width={1585}
            >
              <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-white/80 to-transparent sm:hidden" />
            </BrowserFrame>
            <div className="relative z-20 mt-3 flex flex-wrap items-center justify-between gap-2 px-1 text-xs font-semibold text-slate-600 sm:text-sm">
              ...
              <span className="inline-flex items-center gap-2">
                ...
                Optional read-only status page
              </span>
            </div>
          </LandingReveal>
        </div>
