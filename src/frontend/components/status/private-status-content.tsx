...
export function PrivateStatusContent({ isAuthenticated, publicPageId }: { isAuthenticated: boolean; publicPageId: string }) {
  return (
    <PublicStatusMessage kind="private" eyebrow={`Public status / ${publicPageId}`} title="This status page is private" description="The owner has turned off public sharing for this job search. There is nothing visible here right now.">
